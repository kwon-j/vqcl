...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
                 ...
                 use_checkpoint=False, fused_window_process=False, feat_only=True,**kwargs):
        super().__init__()
    ...
    def forward_features(self, x):
        ...
        if self.feat_only:
            x = torch.transpose(x,1,2) # transpose B,196,768 -> B,768,196
            # x = torch.unflatten(x, 2, (14, 14))  # B,768,196 -> B,768,14,14
            x = torch.reshape(x, (-1,768,14, 14))  # B,768,196 -> B,768,14,14
            # x = F.normalize(x, dim=1) # TODO: should i keep this?
        else:
